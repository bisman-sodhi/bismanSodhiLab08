...
int main(int argc, char *argv[]) {
	...
	if (argc < 4) {
		...
		*/
		...
		createImage<color>(theImage0, theShapes, color(12));
		createImage<int>(theImage1, theShapes, 128);
		createImage<bool>(theImage2, theShapes, true);
		createImage<char>(theImage3, theShapes, '%');
